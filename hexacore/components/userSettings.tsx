      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div className="max-w-screen-md mb-8 lg:mb-16">
                ...
                <p className="text-gray-500 sm:text-xl dark:text-gray-400">Welcome to your settings. Here you can update and change your information and app settings.</p>
            </div>
            <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div>
                    ...
                    <h3 className="mb-2 text-xl font-bold dark:text-white">Personal information</h3>
            ...
            <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Manage channels</h3>
