    ...
    <div className='bottom-0 flex'>
      ...
      <label htmlFor="chat" className="sr-only">Your message</label>
        <div className="flex items-center rounded-lg">
            <textarea id="chat" onKeyDown={sendMessage} onChange={type} value={message} rows={row} className="resize-none pl-4 h-10 focus:h-full break-words p-2 w-full text-sm text-gray-900 rounded-lg border bg-gray-100 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Type message..."></textarea>
              {
              // "Button doesn't work yet" 
              }
              <button onClick={sendMessage} value={message} className="inline-flex justify-center m-2 p-1 text-blue-600 rounded-full cursor-pointer hover:bg-blue-100 dark:text-blue-500 dark:hover:bg-gray-600">
