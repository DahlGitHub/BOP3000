...
const DashboardSidebar = () => {
  ...
  <>
      <div className="sm:hidden absolute top-0 left-10 m-4 px-5 z-50">
        <button
          className="dark:bg-gray-800 dark:text-white text-gray-700 fa-lg p-2 rounded-md"
    ...
    <div className={`absolute inset-0 left-0 w-1/3 top-[70px] bg-white border-r border-gray-200 z-[51] sm:hidden transition-transform ${
