...
const Drawer = ({mainContent, title, isOpen, open, close}) => {
    ...
    return(
        <div>
            ...
            >
                <div className="h-[calc(100vh-70px)] w-auto py-8 overflow-y-auto bg-white border-b border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700">
